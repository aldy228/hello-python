...
def load_icon(filename):
    """Load icon from assets folder, with fallback if not found"""
    try:
        ...
        return None  # Return None to use pygame-drawn fallback


# Try to load icons, but allow None for fallbacks
asset_icons = {
